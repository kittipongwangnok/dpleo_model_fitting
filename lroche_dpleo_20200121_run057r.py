...
lcurve_dpleo_data = open("dpleo_20200121_run057r.dat",'r').readlines()
...
#################################################################################
#Please change the input file
lcurve_dpleo_output = open("dpleo_20200121_run057r.out",'r').readlines()
...
for line in open("dpleo_20200121_run057r.out"):
    li=line.strip()
    if not li.startswith("#"):
...
out = output_result
f = open('output_dpleo_20200121_run057r.txt', 'w')
#for upper_result in upper_result:
...
res = residual_result
f = open('residual_dpleo_20200121_run057r.txt', 'w')
#for upper_result in upper_result:
...
'''
#################################################################################
InputFile_1 = "data_dpleo_20200121_run057r.txt"
Data_1   = np.genfromtxt(InputFile_1)

InputFile_2 = "output_dpleo_20200121_run057r.txt"
Data_2   = np.genfromtxt(InputFile_2)

InputFile_3 = "residual_dpleo_20200121_run057r.txt"
...
ax0.errorbar(MJD_time_1, Flux_1, yerr=Flux_err_1, fmt='o', markersize = 4, alpha = 0.25, color='red', label = 'data\_20200121\_run057r')
